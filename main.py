...
def send_status(message, topic='update_status'):
    """İşlem durumu mesajını yayınlayan fonksiyon.

       Args:
           message (str): Yayınlanacak mesaj.
           topic (str, optional): Yayınlanacak konu adı. Varsayılan değer 'update_status'.
       """
...
class FtpFrame(wx.Frame):
    ...
    def create_toolbar(self):
        ...
        upload_ico = wx.ArtProvider.GetBitmap(
            wx.ART_GO_UP, wx.ART_TOOLBAR, (30, 30))
        upload_tool = self.toolbar.AddTool(
            wx.ID_ANY, 'Upload File', upload_ico,
            'Upload a file')
        ...
        add_ico = wx.ArtProvider.GetBitmap(
            wx.ART_GO_DOWN, wx.ART_TOOLBAR, (30, 30))
        ...
        remove_ico = wx.ArtProvider.GetBitmap(
            wx.ART_MINUS, wx.ART_TOOLBAR, (30, 30))
